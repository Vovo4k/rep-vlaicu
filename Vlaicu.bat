...
rem icube cfg
if %x% equ 80 if %y% equ 3 goto :icube
if %x% equ 80 if %y% equ 4 goto :icube
if %x% equ 80 if %y% equ 5 goto :icube
if %x% equ 80 if %y% equ 6 goto :icube
if %x% equ 80 if %y% equ 7 goto :icube
if %x% equ 80 if %y% equ 8 goto :icube
if %x% equ 81 if %y% equ 3 goto :icube
if %x% equ 81 if %y% equ 4 goto :icube
if %x% equ 81 if %y% equ 5 goto :icube
if %x% equ 81 if %y% equ 6 goto :icube
if %x% equ 81 if %y% equ 7 goto :icube
if %x% equ 81 if %y% equ 8 goto :icube
if %x% equ 82 if %y% equ 3 goto :icube
if %x% equ 82 if %y% equ 4 goto :icube
if %x% equ 82 if %y% equ 5 goto :icube
if %x% equ 82 if %y% equ 6 goto :icube
if %x% equ 82 if %y% equ 7 goto :icube
if %x% equ 82 if %y% equ 8 goto :icube
if %x% equ 83 if %y% equ 3 goto :icube
if %x% equ 83 if %y% equ 4 goto :icube
if %x% equ 83 if %y% equ 5 goto :icube
if %x% equ 83 if %y% equ 6 goto :icube
if %x% equ 83 if %y% equ 7 goto :icube
if %x% equ 83 if %y% equ 8 goto :icube
if %x% equ 84 if %y% equ 3 goto :icube
if %x% equ 84 if %y% equ 4 goto :icube
if %x% equ 84 if %y% equ 5 goto :icube
if %x% equ 84 if %y% equ 6 goto :icube
if %x% equ 84 if %y% equ 7 goto :icube
if %x% equ 84 if %y% equ 8 goto :icube
if %x% equ 85 if %y% equ 3 goto :icube
if %x% equ 85 if %y% equ 4 goto :icube
if %x% equ 85 if %y% equ 5 goto :icube
if %x% equ 85 if %y% equ 6 goto :icube
if %x% equ 85 if %y% equ 7 goto :icube
if %x% equ 85 if %y% equ 8 goto :icube
if %x% equ 86 if %y% equ 3 goto :icube
if %x% equ 86 if %y% equ 4 goto :icube
if %x% equ 86 if %y% equ 5 goto :icube
if %x% equ 86 if %y% equ 6 goto :icube
if %x% equ 86 if %y% equ 7 goto :icube
if %x% equ 86 if %y% equ 8 goto :icube
if %x% equ 87 if %y% equ 3 goto :icube
if %x% equ 87 if %y% equ 4 goto :icube
if %x% equ 87 if %y% equ 5 goto :icube
if %x% equ 87 if %y% equ 6 goto :icube
if %x% equ 87 if %y% equ 7 goto :icube
if %x% equ 87 if %y% equ 8 goto :icube
goto :desktop
...
batbox /g 0 2 /c 0x07 /d ""
insertbmp /p:"img\upbarsetting.bmp" /x:0 /y:0 /z:100
cmdMenuSel f8%f0 "<< Go back" "Minda"
if %ERRORLEVEL% == 1 goto :bcksetall
